...
-- Example:
-- update public.faculty set email='name@bme.buet.ac.bd' where full_name='Faculty Name';
-- insert into public.allowed_users(email,faculty_id,app_role)
-- select 'name@bme.buet.ac.bd', id, 'faculty' from public.faculty where full_name='Faculty Name'
